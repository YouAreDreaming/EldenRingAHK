...
class C_UserSettings
{
	...
	initSettings(settingsFile)
	{
		...
		global V_SPELLAUTOLOCK1
		global V_SPELLAUTOLOCK2
		global V_SPELLAUTOLOCK3
		global V_SPELLAUTOLOCK4
		global V_SPELLAUTOLOCK5
		global V_SPELLAUTOLOCK6
		global V_SPELLAUTOLOCK7
		global V_SPELLAUTOLOCK8
		global V_SPELLAUTOLOCK9
		global V_SPELLAUTOLOCK10
		
		global V_BELTAUTOLOCK1
		global V_BELTAUTOLOCK2
		global V_BELTAUTOLOCK3
		global V_BELTAUTOLOCK4
		global V_BELTAUTOLOCK5
		global V_BELTAUTOLOCK6
		global V_BELTAUTOLOCK7
		global V_BELTAUTOLOCK8
		global V_BELTAUTOLOCK9
		global V_BELTAUTOLOCK10
		...
		G_settings["AUTOLOCK"] := []
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK1"] := V_SPELLAUTOLOCK1
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK2"] := V_SPELLAUTOLOCK2
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK3"] := V_SPELLAUTOLOCK3
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK4"] := V_SPELLAUTOLOCK4
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK5"] := V_SPELLAUTOLOCK5
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK6"] := V_SPELLAUTOLOCK6
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK7"] := V_SPELLAUTOLOCK7
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK8"] := V_SPELLAUTOLOCK8
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK9"] := V_SPELLAUTOLOCK9
			G_settings["AUTOLOCK"]["V_SPELLAUTOLOCK10"] := V_SPELLAUTOLOCK10

			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK1"] := V_BELTAUTOLOCK1
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK2"] := V_BELTAUTOLOCK2
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK3"] := V_BELTAUTOLOCK3
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK4"] := V_BELTAUTOLOCK4
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK5"] := V_BELTAUTOLOCK5
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK6"] := V_BELTAUTOLOCK6
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK7"] := V_BELTAUTOLOCK7
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK8"] := V_BELTAUTOLOCK8
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK9"] := V_BELTAUTOLOCK9
			G_settings["AUTOLOCK"]["V_BELTAUTOLOCK10"] := V_BELTAUTOLOCK10 
