;-----------------------------------------------------------------------
;-----
;----- You can add custom HotKeys or static HotKeys here.
;----- These HotKeys cannot be disabled by the app but this is provided
;----- for users who want more custom control over their hotkeys than 
;----- what the application allows for.
;-----
;-----------------------------------------------------------------------
; Warning:  
...
; keyboard for ER menus an map and need to hard-code a setting to those keys feel free but
